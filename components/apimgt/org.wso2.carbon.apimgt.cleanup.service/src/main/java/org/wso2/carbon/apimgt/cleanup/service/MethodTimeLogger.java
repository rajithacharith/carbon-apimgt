...
public class MethodTimeLogger {
     ...
     * org.wso2.carbon.apimgt.cleanup.service and consist of the annotation, @MethodStats.
     *
    ...
    /**
     * This is an AspectJ pointcut defined to apply to all methods within the package,
     * org.wso2.carbon.apimgt.cleanup.service. Also, the pointcut looks for the system property to enable
    ...
    public static boolean pointCutAll() {
        if (!isLogAllSet) {
            ...
            if (StringUtils.isNotEmpty(config)) {
                logAllMethods = config.contains("org.wso2.carbon.apimgt.cleanup.service");
                isLogAllSet = true;
            }
        }
